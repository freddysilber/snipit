import { Acronym } from './types/acronym.type';
...
/**
 * Cleans number input: to use the number and decimal to format a string using the parts appended with an acronym
...
/**
 * Abbreviates a string or number to an abbreviated version with an acronym
 * @example 2657 => '2.6K'
 * @param input The number or string to 'trim'
 * @returns String or number of the cleaned input
 */
function abbreviateNumber(input: number): string | number {
